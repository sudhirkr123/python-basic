...
def Adding1(win):
    ...
    Label(win,text="Employee Id:",font="20").place(x=30,y=70)
    Label(win,text="Name:",font="20").place(x=30,y=110)
    Label(win,text="Contact:",font="20").place(x=30,y=150)
    Label(win,text="Dept:",font="20").place(x=30,y=190)
    Label(win,text="Email:",font="20").place(x=30,y=230)
    # entry
    emp_info=StringVar()
    name_info=StringVar()
